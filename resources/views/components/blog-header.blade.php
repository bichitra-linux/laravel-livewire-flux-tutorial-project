...
<body class="antialiased bg-gray-50 dark:bg-gray-900">
    ...
    <div> {{-- single root wrapper for the component --}}
        <header
            class="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 shadow-sm sticky top-0 z-50">
            <div class="max-w-7xl mx-auto px-6">
                <div class="flex items-center justify-between h-20">
                    <div class="flex items-center gap-4">
                        <a href="{{ url('/') }}"
                            ...
                            <div
                                class="w-12 h-12 rounded-full bg-gradient-to-r from-blue-500 to-purple-500 text-white flex items-center justify-center font-bold shadow-md">
                                B
                            </div>
                            <div>
                                <h1 class="text-lg font-bold text-gray-900 dark:text-white">{{ $title ?? 'The Brief' }}
                                </h1>
                    ...
                    <nav class="hidden md:flex items-center space-x-6">
                        <a href="{{ route('public.posts.index') }}"
                            class="text-gray-700 dark:text-gray-200 hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-200 font-medium">All
                            Posts</a>
                        <a href="{{ route('public.posts.index', ['category' => 'politics']) }}"
                            class="text-gray-700 dark:text-gray-200 hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-200 font-medium">Politics</a>
                        <a href="{{ route('public.posts.index', ['category' => 'tech']) }}"
                            class="text-gray-700 dark:text-gray-200 hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-200 font-medium">Tech</a>
                        <a href="{{ route('public.posts.index', ['category' => 'culture']) }}"
                            class="text-gray-700 dark:text-gray-200 hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-200 font-medium">Culture</a>
                    </nav>
                    ...
                    <button id="theme-toggle" type="button" aria-label="Toogle Theme"
                        class="p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-all duration-600 ml-2">
                        {{-- Light (sun) icon --}}
                        <svg id="theme-toggle-light-icon" xmlns="http://www.w3.org/2000/svg"
                            class="w-5 h-5 hidden text-yellow-500" viewBox="0 0 20 20" fill="currentColor"
                            aria-hidden="true">
                            <path
                        ...
                        <svg id="theme-toggle-dark-icon" xmlns="http://www.w3.org/2000/svg"
                            class="w-5 h-5 hidden text-gray-200" viewBox="0 0 20 20" fill="currentColor"
                            aria-hidden="true">
                    ...
                    <button id="mobile-menu-toggle" type="button" aria-label="Toggle Menu"
                        class="md:hidden p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-all duration-200 ml-2">
                ...
                {{-- Mobile menu --}}
                <div id="mobile-menu"
                    class="md:hidden hidden bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700 py-4">
                    <nav class="flex flex-col space-y-4">
                        <a href="{{ route('posts.index') }}"
                            class="text-gray-700 dark:text-gray-200 hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-200 font-medium px-4">All
                            Posts</a>
                        <a href="{{ route('posts.index', ['category' => 'politics']) }}"
                            class="text-gray-700 dark:text-gray-200 hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-200 font-medium px-4">Politics</a>
                        <a href="{{ route('posts.index', ['category' => 'tech']) }}"
