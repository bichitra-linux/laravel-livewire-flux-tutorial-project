<x-layouts.app>
                ...
                <div class="grid lg:grid-cols-3 gap-6">
                    ...
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        <div class="bg-white dark:bg-zinc-800 rounded-xl shadow-lg border border-zinc-200 dark:border-zinc-700 p-6 hover:shadow-xl transition-shadow">
                            ...
                            <trix-editor 
                                input="content" 
                                class="trix-content border-2 border-zinc-200 dark:border-zinc-700 rounded-lg shadow-sm focus:ring-2 focus:ring-purple-500 focus:border-purple-500 dark:bg-zinc-900 dark:text-white transition-all @error('content') @enderror"
                                placeholder="Start writing your post content here..."></trix-editor>
                            @error('content')
                                <p class="text-red-500 text-sm mt-2 flex items-center gap-1">
                                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"></path>
                        ...
                        <div class="bg-white dark:bg-zinc-800 rounded-xl shadow-lg border border-zinc-200 dark:border-zinc-700 p-6 hover:shadow-xl transition-shadow">
                            <div class="flex items-center gap-3 mb-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-zinc-500 dark:text-zinc-400">Add a visual appeal to your post</p>
                                </div>
                            </div>
                            ...
                            <div class="relative">
                                ...
                                <label for="image" class="flex flex-col items-center justify-center w-full h-64 border-2 border-dashed border-zinc-300 dark:border-zinc-600 rounded-lg cursor-pointer bg-zinc-50 dark:bg-zinc-900 hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors">
                                    <div id="upload-area" class="flex flex-col items-center justify-center pt-5 pb-6">
                                        ...
                                        <p class="mb-2 text-sm text-zinc-600 dark:text-zinc-400"><span class="font-semibold">Click to upload</span> or drag and drop</p>
                                        <p class="text-xs text-zinc-500 dark:text-zinc-400">PNG, JPG, GIF, WebP (MAX. 4MB • 1920×1080 recommended)</p>
                                    </div>
                    ...
                    <div class="space-y-6">
                        {{-- Publish Card --}}
                        <div class="bg-white dark:bg-zinc-800 rounded-xl shadow-lg border border-zinc-200 dark:border-zinc-700 p-6 sticky top-6">
                            <div class="flex items-center gap-3 mb-4">
    ...
    <script>
        ...
        document.addEventListener("trix-file-accept", function(e) {
            ...
            notification.textContent = 'Please use the Featured Image field above for images';
